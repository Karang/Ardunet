...
/*  xt2000.h  -  Xtensa XT2000 Evaluation Board specific definitions  */
...
#if !defined(_ASMLANGUAGE) && !defined(__ASSEMBLER__) && !defined(_NOCLANGUAGE)
...
#endif /*!_ASMLANGUAGE && !__ASSEMBLER__ && !_NOCLANGUAGE*/
