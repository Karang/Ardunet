...
uart-16550-board.h  Board-specific UART info on the Avnet AV60 (XT-AV60) board.
...
The XT-AV60 board contains a single 16550 UART implemented on the FPGA.
...
/* 
The UART's registers are connected at word addresses on the XT-AV60.
